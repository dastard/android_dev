...
public enum FreeBaseTopicAPI implements WebServiceable {

	FREE_BASE_TOPIC_BASIC("/basic"),
	FREE_BASE_TOPIC_STANDARD("/standard");

	private static final String HTTP = "http";
	private static final String URL_FREEBASE_TOPIC_API = "api.freebase.com/api/experimental/topic";
	private static final String UTF_8 = "UTF-8";

	private static final String FREEBASE_SURFER = "FREEBASE SURFER";
	private final String mode;
	
	private FreeBaseTopicAPI(final String mode) {
		this.mode = mode;
	}
	...
	public WebServiceResponseVO execute(final ArrayList<NameValuePair> nameValuePairs) {
		...
		final URI uri;
		try {
			uri = URIUtils.createURI(HTTP, URL_FREEBASE_TOPIC_API, -1, mode, URLEncodedUtils.format(nameValuePairs, UTF_8), null);
